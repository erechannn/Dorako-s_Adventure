...
void StageManager::initialize_stages() {
	stages_ = {
		{1,"草原ステージ",Octree_Stage1,Octree_Stage1Collider,{0.0f,-30.0f,0.0f},30.0f,7,StageType::NORMAL,true},
		...
		{4,"タイトルステージ",Octree_TestStage,Octree_TestStageCollider,{0.0f,-20.0f,0.0f},20.0f,5,StageType::SAMPLE,true}
	};
}
